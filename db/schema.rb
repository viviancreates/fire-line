...
ActiveRecord::Schema[8.0].define(version: 2025_02_23_230553) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  create_table "air_quality_readings", force: :cascade do |t|
  ...
  create_table "report_recipients", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["report_id"], name: "index_report_recipients_on_report_id"
  end
  ...
  add_foreign_key "report_recipients", "reports"
